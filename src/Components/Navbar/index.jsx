  ...
  return (
    <>
      <div className="navbar">
        ...
        <NavLink to={"/repositories"} className="navbar__item">
          <svg
            aria-hidden="true"
            height="16"
            viewBox="0 0 16 16"
          ...
          <h3>
            Repositories <span>41 </span>
          </h3>
        </NavLink>
        <a href="https://github.com/Jahongir0126?tab=projects" target={"_blank"} className="navbar__item">
          <svg
            aria-hidden="true"
            height="16"
            viewBox="0 0 16 16"
        ...
        <a href="https://github.com/Jahongir0126?tab=packages" target={"_blank"} className="navbar__item">
          <svg
            aria-hidden="true"
            height="16"
            viewBox="0 0 16 16"
        ...
        <a href="https://github.com/Jahongir0126?tab=stars" target={"_blank"} className="navbar__item">
          <svg
            aria-hidden="true"
            height="16"
            viewBox="0 0 16 16"
